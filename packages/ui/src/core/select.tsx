...
type SelectRootProps = SelectPrimitive.Root.Props<string> & {
  /** Explicit reading direction, retained from the previous Radix API. */
  dir?: 'ltr' | 'rtl';
};

function Select({ dir, ...props }: SelectRootProps) {
  const root = <SelectPrimitive.Root data-slot="select" {...props} />;
